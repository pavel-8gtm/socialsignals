...
// Enhanced profile upsert function using comprehensive matching system
  ...
  for (const reactor of profiles) {
    ...
    if (existingProfileId) {
      ...
      if (data) {
        ...
        console.log(`🔍 Found existing profile via comprehensive matching: ${reactor.name} (${existingProfileId})`)
      }
    }
